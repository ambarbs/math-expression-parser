...
var grammar = {
  ...
  ParserRules: [
    ...
    },
    {
      ...
      postprocess: ([left, , operator, , right]) =>
    ...
    { name: 'Multiplication', symbols: ['Primary'], postprocess: unwrap },
    {
      ...
      postprocess: numberLiteral,
    },
    {
      name: 'Primary',
      symbols: [
        lexer.has('leftParen') ? { type: 'leftParen' } : leftParen,
        '_',
        'Addition',
        '_',
        lexer.has('rightParen') ? { type: 'rightParen' } : rightParen,
      ],
      postprocess: ([, , expression]) => expression,
    },
    {
    ...
    },
    {
      ...
      symbols: [
        'Addition',
        '_',
        lexer.has('notEquals') ? { type: 'notEquals' } : notEquals,
        '_',
        'Addition',
      ],
      postprocess: ([left, , operator, , right]) =>
